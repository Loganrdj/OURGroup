...
const Navbar = () => {
  ...
  return (
    <div id="green-box" className={window.location.pathname === withPrefix("/about") ? "navbar-background-image" : window.location.pathname === withPrefix("/projects") ? "navbar-background-image-projects" : ""}>
      <div className={window.location.pathname === withPrefix("/about") ? "navbar green-box" : window.location.pathname === withPrefix("/projects") ? "navbar green-box" : "navbar"}>
